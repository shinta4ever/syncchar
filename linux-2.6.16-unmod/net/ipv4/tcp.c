...
void __init tcp_init(void)
{
	...
	/* DEP: Lacking an __init call in tcp_minisocks.c, I am
	 * putting this registration here 
	 */
	OSA_REGISTER_SPINLOCK(&tcp_death_row.death_lock, 
			      "inet_timewait_death_row->death_lock", 35);
	...
	for (i = 0; i < tcp_hashinfo.bhash_size; i++) {
		...
		OSA_REGISTER_SPINLOCK(&tcp_hashinfo.bhash[i].lock, 
				      "tcp_hashinfo.bhash->lock", 24);
