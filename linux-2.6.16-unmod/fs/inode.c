...
void inode_init_once(struct inode *inode)
{
	...
	spin_lock_init(&inode->i_data.i_mmap_lock);
 	OSA_REGISTER_SPINLOCK(&inode->i_data.i_mmap_lock, "inode->i_data.i_mmap_lock", 25);
	INIT_LIST_HEAD(&inode->i_data.private_list);
 	OSA_REGISTER_SPINLOCK(&inode->i_data.private_lock, "inode->i_data.private_lock", 26);
	spin_lock_init(&inode->i_data.private_lock);
 	OSA_REGISTER_SPINLOCK(&inode->i_lock, "inode->i_lock", 13);
