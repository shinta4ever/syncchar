...
static journal_t * journal_init_common (void)
{
	...
	OSA_REGISTER_SPINLOCK(&journal->j_revoke_lock, "journal_t->j_revoke_lock", 24);
	OSA_REGISTER_SPINLOCK(&journal->j_list_lock, "journal_t->j_list_lock", 22);
	OSA_REGISTER_SPINLOCK(&journal->j_state_lock, "journal_t->j_state_lock", 23);
